...
fn main() {
    ...
    println!(
        "{:?} should be 2",
        length_of_longest_substring("aab".to_string())
    );
    println!(
        "{:?} should be 3",
    ...
    println!(
        "{:?} should be 3",
        length_of_longest_substring_copied("dvdf".to_string())
    );
    println!(
        "{:?} should be 2",
        length_of_longest_substring_copied("aab".to_string())
    );
    println!(
        "{:?} should be 3",
    ...
    println!(
        "{:?} should be 1",
        length_of_longest_substring_copied("bbbbb".to_string())
    );
    println!(
        "{:?} should be 3",
        length_of_longest_substring_copied("pwwkew".to_string())
    );
}
...
fn length_of_longest_substring_copied(s: String)->i32{
