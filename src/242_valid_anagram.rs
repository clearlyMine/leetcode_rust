fn main(){
    ...
    println!(
        "{:?} should be false",
        is_anagram(String::from("rat"),String::from("car"))
    );
    println!(
        "{:?} should be true",
       is_anagram_2(String::from("anagram"), String::from("nagaram"))
    );
    println!(
        "{:?} should be false",
        is_anagram_2(String::from("rat"),String::from("car"))
    );
    println!(
        "{:?} should be true",
       is_anagram_copied(String::from("anagram"), String::from("nagaram"))
    );
    println!(
        "{:?} should be false",
        is_anagram_copied(String::from("rat"),String::from("car"))
    );
}
